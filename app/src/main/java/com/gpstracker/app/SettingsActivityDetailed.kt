...
class SettingsActivityDetailed : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            setContentView(R.layout.activity_settings_detailed)
            
            // 设置Toolbar
            toolbar = findViewById(R.id.toolbar)
            setSupportActionBar(toolbar)
            supportActionBar?.setDisplayHomeAsUpEnabled(true)
            supportActionBar?.title = "详细设置"
            ...
            android.util.Log.e("SettingsActivityDetailed", "初始化失败", e)
    ...
    private fun resetToDefaults() {
        try {
            ...
            android.util.Log.e("SettingsActivityDetailed", "重置设置失败", e)
    ...
    private fun saveSettings() {
        try {
            ...
            android.util.Log.e("SettingsActivityDetailed", "保存设置失败", e)
